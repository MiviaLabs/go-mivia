...
- Repo lives in WSL at `/home/mac/mivialabs/mivialabs-agents-monorepo`. From Codex Desktop PowerShell, prefer WSL-native commands such as `wsl git -C /home/mac/mivialabs/mivialabs-agents-monorepo status --short`.
...
- Git: `wsl git -C /home/mac/mivialabs/mivialabs-agents-monorepo status --short --untracked-files=all`.
