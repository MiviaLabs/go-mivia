...
- `projects.workspace.file_read` / `projects_workspace_file_read`: current eligible file text by `file_id` or project-relative `relative_path`, capped by `max_bytes`, with an opaque edit token.
