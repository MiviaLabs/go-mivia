...
func BootstrapSchema() GraphSchema {
	return GraphSchema{
		NodeLabels: []string{
			...
			"WorkPlan",
			"WorkTask",
			"WorkTaskEvidenceAttachment",
			"WorkTaskContextPackAttachment",
			"WorkTaskClaimAttachment",
			"WorkTaskVerifierResultAttachment",
			"WorkTaskReviewResultAttachment",
			"WorkTaskKnowledgeCandidateAttachment",
			"WorkTaskArtifactAttachment",
			"WorkTaskRunAttachment",
		},
		Relationships: []Relationship{
			...
			{Type: "PROJECT_HAS_WORK_PLAN", From: "Project", To: "WorkPlan"},
			{Type: "WORK_PLAN_HAS_WORK_TASK", From: "WorkPlan", To: "WorkTask"},
			{Type: "WORK_TASK_DEPENDS_ON", From: "WorkTask", To: "WorkTask"},
			{Type: "WORK_TASK_HAS_EVIDENCE_ATTACHMENT", From: "WorkTask", To: "WorkTaskEvidenceAttachment"},
			{Type: "WORK_TASK_HAS_CONTEXT_PACK_ATTACHMENT", From: "WorkTask", To: "WorkTaskContextPackAttachment"},
			{Type: "WORK_TASK_HAS_CLAIM_ATTACHMENT", From: "WorkTask", To: "WorkTaskClaimAttachment"},
			{Type: "WORK_TASK_HAS_VERIFIER_RESULT_ATTACHMENT", From: "WorkTask", To: "WorkTaskVerifierResultAttachment"},
			{Type: "WORK_TASK_HAS_REVIEW_RESULT_ATTACHMENT", From: "WorkTask", To: "WorkTaskReviewResultAttachment"},
			{Type: "WORK_TASK_HAS_KNOWLEDGE_CANDIDATE_ATTACHMENT", From: "WorkTask", To: "WorkTaskKnowledgeCandidateAttachment"},
			{Type: "WORK_TASK_HAS_ARTIFACT_ATTACHMENT", From: "WorkTask", To: "WorkTaskArtifactAttachment"},
			{Type: "WORK_TASK_HAS_RUN_ATTACHMENT", From: "WorkTask", To: "WorkTaskRunAttachment"},
		},
	}
}
