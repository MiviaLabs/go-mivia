...
func defaultKnownRoutes() []string {
	return []string{
		...
		"/api/v1/projects/*/automations/*/status", "/api/v1/projects/*/automations/*/runs", "/api/v1/projects/*/automations/*/parallel-batches",
		...
		"/api/v1/projects/{id}/automations/{automation_id}/status", "/api/v1/projects/{id}/automations/{automation_id}/runs", "/api/v1/projects/{id}/automations/{automation_id}/parallel-batches",
