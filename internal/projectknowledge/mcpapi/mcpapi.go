...
func ToolDefinitions() []map[string]any {
	...
	rationaleText := map[string]any{"type": "string", "minLength": 1, "maxLength": 1000}
	...
	return []map[string]any{
		...
		{"name": "projects.knowledge.validate", "title": "Validate Knowledge Candidate", "description": "Validate one project-scoped knowledge candidate using the configured Evidence Graph and Confidence Engine adapter.", "inputSchema": transitionSchema(ref, rationaleText)},
		{"name": "projects.knowledge.promote_project", "title": "Promote Project Knowledge", "description": "Promote validated knowledge at project scope using the configured Evidence Graph and Confidence Engine adapter.", "inputSchema": transitionSchema(ref, rationaleText)},
		{"name": "projects.knowledge.submit_org_review", "title": "Submit Knowledge For Org Review", "description": "Explicitly submit project-promoted knowledge for default org review; this does not promote org knowledge automatically.", "inputSchema": objectSchema(map[string]any{"id": ref, "knowledge_id": ref, "org_ref": map[string]any{"type": "string", "enum": []string{projectknowledge.DefaultOrgRef}}, "decision_ref": ref, "verifier_ref": ref, "rationale": rationaleText, "decided_by": ref}, []string{"id", "knowledge_id", "org_ref", "decision_ref", "verifier_ref", "rationale", "decided_by"})},
		{"name": "projects.knowledge.promote_org", "title": "Promote Org Knowledge", "description": "Explicitly promote org-reviewed knowledge to default org scope with stricter metadata gates derived from Evidence Graph and Confidence Engine metadata.", "inputSchema": objectSchema(map[string]any{"id": ref, "knowledge_id": ref, "scope": map[string]any{"type": "string", "enum": []string{projectknowledge.ScopeOrg}}, "org_ref": map[string]any{"type": "string", "enum": []string{projectknowledge.DefaultOrgRef}}, "decision_ref": ref, "verifier_ref": ref, "rationale": rationaleText, "decided_by": ref}, []string{"id", "knowledge_id", "scope", "org_ref", "decision_ref", "verifier_ref", "rationale", "decided_by"})},
		{"name": "projects.knowledge.reject", "title": "Reject Knowledge", "description": "Reject a knowledge record without deleting metadata.", "inputSchema": objectSchema(map[string]any{"id": ref, "knowledge_id": ref, "decision_ref": ref, "verifier_ref": ref, "rationale": rationaleText, "decided_by": map[string]any{"type": "string", "maxLength": 200}}, []string{"id", "knowledge_id", "decision_ref", "verifier_ref", "rationale"})},
		{"name": "projects.knowledge.supersede", "title": "Supersede Knowledge", "description": "Mark a knowledge record as superseded without deleting metadata.", "inputSchema": objectSchema(map[string]any{"id": ref, "knowledge_id": ref, "superseded_by_ref": ref, "decision_ref": ref, "verifier_ref": ref, "rationale": rationaleText, "decided_by": map[string]any{"type": "string", "maxLength": 200}}, []string{"id", "knowledge_id", "superseded_by_ref", "decision_ref", "verifier_ref", "rationale"})},
