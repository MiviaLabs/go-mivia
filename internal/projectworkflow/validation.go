...
func (v *workflowValidator) validateSteps(agents []WorkflowAgentDefinition, steps []WorkflowStep) {
	...
	for i, step := range steps {
		...
		v.textList(step.AcceptanceCriteria, base+".acceptance_criteria", 500)
		v.textList(step.StopConditions, base+".stop_conditions", 500)
		v.textList(step.VerifierLadder, base+".verifier_ladder", 500)
		v.optionalText(step.RegressionApplicability, base+".regression_test_applicability", 500)
